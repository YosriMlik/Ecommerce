...
var require_vuex_persistedstate = __commonJS({
  "node_modules/vuex-persistedstate/dist/vuex-persistedstate.js"(exports, module) {
    var r = function(r2) {
      return function(r3) {
    ...
    function u(e2, i2, a) {
      ...
      return f === Array.isArray(e2) ? f ? a.arrayMerge(e2, i2, a) : function(r2, e3, n2) {
        var i3 = {};
    ...
    module.exports = function(r2) {
      ...
      return r2.fetchBeforeUse && (f = s()), function(n3) {
        ...
        })(n3)), (r2.subscriber || a)(n3)(function(n4, i2) {
...
export default require_vuex_persistedstate();
//# sourceMappingURL=vuex-persistedstate_dist_vuex-persistedstate__js.js.map
